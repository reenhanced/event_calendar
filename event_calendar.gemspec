...
Gem::Specification.new do |s|
  ...
  s.authors = ["Nicholas Hance", "Jeff Schuil"]
  s.date = "2012-04-04"
  ...
  s.homepage = "http://github.com/reenhanced/event_calendar"
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<event_calendar>, [">= 0"])
      ...
      s.add_dependency(%q<event_calendar>, [">= 0"])
